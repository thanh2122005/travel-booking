// TÓM TẮT API: src/app/api/auth/forgot-password/route.ts
...
export async function POST(request: Request) {
  ...
  // BƯỚC 2: Parse JSON an toàn + kiểm tra hợp lệ dữ liệu đầu vào.
  ...
  try {
    // BƯỚC 3: Tạo OTP reset. Hàm service sẽ tự kiểm tra user có tồn tại hay không.
